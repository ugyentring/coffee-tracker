...
const Hero = () => {
  return (
    <>
      <h1>
        Coffee Tracking for Coffee <abbr title="And enthusiast or devotee">Fiends</abbr>!
      </h1>
      ...
      <div className="card info-card">
        <div>
          <i className="fa-solid fa-circle-info"></i>          <h3>Did you know ...</h3>
        </div>
        <h5>That caffeine&apos;s half-lif is about 5 hours</h5>
